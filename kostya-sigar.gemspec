...
Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE", "NOTICE", "README.md", "Rakefile", "bindings/ruby/extconf.rb", "bindings/ruby/rbsigar.c", "bindings/ruby/rbsigar_generated.rx", "include/sigar.h", "include/sigar_fileinfo.h", "include/sigar_format.h", "include/sigar_getline.h", "include/sigar_log.h", "include/sigar_private.h", "include/sigar_ptql.h", "include/sigar_util.h", "src/os/darwin/Info.plist.in", "src/os/darwin/darwin_sigar.c", "src/os/darwin/sigar_os.h", "src/os/linux/linux_sigar.c", "src/os/linux/sigar_os.h", "src/sigar.c", "src/sigar_cache.c", "src/sigar_fileinfo.c", "src/sigar_format.c", "src/sigar_getline.c", "src/sigar_ptql.c", "src/sigar_signal.c", "src/sigar_util.c", "src/sigar_version.c.in", "src/sigar_version_autoconf.c.in", "version.properties"]
